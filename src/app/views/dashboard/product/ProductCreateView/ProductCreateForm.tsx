...
const ProductCreateForm = ({ className, ...rest }: Props) => {
  ...
  return (
    /*the required attributes or properties of Formik need to be
    initialized.
    ...
    */
    <Formik
      ...
      /* The onSubmit, you can just initially write a function without
      anything inside.
      Usually, I'd write an alert message first to trigger it as a proof of
      concept. */
